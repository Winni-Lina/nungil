...
![시스템 구성도](docs/다이어그램/시스템구성도_v2.png)
...
|:---:|:---:|
| <img src="docs/images/e2e%201.png" width="440"> | <img src="docs/images/e2e%202.png" width="440"> |
| **자유 시간 질문** | **보호자 알림 및 보고서** |
| <img src="docs/images/e2e%203.png" width="440"> | <img src="docs/images/e2e%204.png" width="440"> |
...
| 메뉴 구성도 | 유스케이스 |
|:---:|:---:|
| ![메뉴](docs/images/메뉴구성도.png) | ![유스케이스](docs/images/유스케이스.png) |

- **SRS (요구사항 명세)**: [문서/눈길_SRS_v3.0.xlsx](문서/눈길_SRS_v3.0.xlsx)
- **일정표 (스프린트 일정 · 간트 차트)**: [문서/눈길_일정표.xlsx](문서/눈길_일정표.xlsx)
- **ERD**:
...
AI 프롬프트 실호출 검증: **8개 시나리오 중 7개 통과 (87.5%)** → [검증 결과 상세](기술보고서.md#6-테스트-결과)
...
| **[📑 설계 산출물](문서)** | 요구사항 명세(SRS)와 스프린트 일정·간트 차트. 무엇을·언제 만들기로 했는지 정리한 계획 문서입니다. | 요구사항·일정을 확인하려는 분 |
